...
LINKAGE istream& operator >>( istream& in, SpatialDomain & c);
LINKAGE ostream& operator <<( ostream& out, const SpatialDomain & c);
LINKAGE ostream& operator <<( ostream& out, SpatialDomain & c);
