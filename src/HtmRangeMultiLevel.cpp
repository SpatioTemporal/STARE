...
static int const errorCountMax = 100; // TODO setup a configuration file that reads this as a property
/**
...
#ifdef DIAG        
	cout << "HRML::Iterate::errorCount exceeds max" << endl << flush;
#endif
	//				exit(1);
      }
#ifdef DIAG      
...
#undef hexOut
	...
	errorCount++; if(errorCount>errorCountMax) {
	  ...
	  throw SpatialFailure("HtmRangeMultiLevel::HRML::5.1::errorCount-exceeds-max");
	}
	lo1 = l_p;
	hi1 = h_p;
...
#undef hexOut3
	...
	//				done = true;
      ...
      // exit(1);
      throw SpatialFailure("HtmRangeMultiLevel::MergeRange 8000-9999 Unknown error");      
    }
